  ...
  data: () => ({
    ...
    researchTeam: [
      ...
      },
      {
        ...
        position: "Bioprocess Researcher",
        img: "Denise-Cifuentes.jpg",
      },
      {
        name: "Patricio Muñoz",
        position: "Bioproduct Researcher",
        img: "Patricio-Munoz.jpg",
      },
      {
        name: "Catalina Pavez",
