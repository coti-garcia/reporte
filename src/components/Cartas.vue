<template>
  ...
  >
    <div class="container-fluid">
      <div class="row carta-wrapper bg-gray section-space--ptb_120">
        <div class="col-md-3 col-lg-2">      
          ...
          <div class="testimonial-slider__author">
            <h6 class="bodega">  Este documento es una pausa en el camino para reflexionar sobre nuestros logros y forma de trabajo, de manera de seguir apoyando la innovación en la industria y la sociedad chilena</h6>
      ...
      <div class="row carta-wrapper carta-2 section-space--ptb_120">
